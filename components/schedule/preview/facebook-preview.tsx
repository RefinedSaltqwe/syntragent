        ...
        {images && images.length > 0 && (
          <div className="flex gap-2 overflow-x-auto no-scrollbar pb-1 mb-4">
            {images.map((image, index) => (
              <div
                key={index}
                className="relative shrink-0 w-[90%] aspect-[4/4] max-w-[350px]"
              >
                <img
                  src={image}
