      ...
      case ChannelTypeEnum.INSTAGRAM:
        return (
          <InstagramPreview
            text={content.text}
            images={imageUrls}
            handle={channel?.handle || "Syntragent"}
          />
        );
      case ChannelTypeEnum.THREADS:
        return <ThreadPreview text={content.text} images={imageUrls} />;
      case ChannelTypeEnum.FACEBOOK:
        return <FacebookPreview text={content.text} images={imageUrls} />;
      case ChannelTypeEnum.BLUESKY:
        return <BlueSkyPreview text={content.text} images={imageUrls} />;
      case ChannelTypeEnum.YOUTUBE:
        return <YoutubePreview text={content.text} images={imageUrls} />;
      default:
        return <div></div>;
    }
  };
